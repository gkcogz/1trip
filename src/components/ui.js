 ...
 */
export function EmojiButton(_a) {
    var emoji = _a.emoji, label = _a.label, title = _a.title, onClick = _a.onClick, _b = _a.variant, variant = _b === void 0 ? 'btn' : _b, _c = _a.className, className = _c === void 0 ? '' : _c;
    var base = variant === 'btn' ? 'btn' :
        variant === 'ghost' ? 'btn-ghost' :
            variant === 'icon' ? 'btn-icon' :
                /* chip */ 'chip';
    // İçerde metni hover’da açmak için group + transition kullanıyoruz.
    return (_jsxs("button", { type: "button", onClick: onClick, title: title || label, className: "group ".concat(base, " ").concat(className), "aria-label": label, children: [_jsx("span", { "aria-hidden": true, className: "select-none", children: emoji }), _jsx("span", { className: "sr-only", children: label }), _jsx("span", { "aria-hidden": true, className: 
